...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pxg3so.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pxg3so.containers.anotherwebservice.com/
...
```
git clone git@github.com:ankit2911/container-pxg3so.git
cd container-pxg3so
```
...
```
docker attach container-pxg3so
```
